...
class Server {
    ...
    constructor(){
        ...
        this.docentePath = '/api/docente'//ruta publica
        this.novedadPath = '/api/novedad'//ruta publica
    ...
    routes(){
        this.app.use(this.docentePath, require('../routes/docentes.js'))
        this.app.use(this.novedadPath, require('../routes/novedades.js'))
    }
